...
{\ttfamily \#include "{}gate\+\_\+driver\+\_\+control.\+h"{}}\newline
...
\hline
\end{DoxyParams}
\texorpdfstring{$<$}{<} Run diagnostics and logging.
...
\hline
\end{DoxyParams}
\texorpdfstring{$<$}{<} Run battery monitoring.
...
\hline
\end{DoxyParams}
\texorpdfstring{$<$}{<} Run Bluetooth communication.
...
\hline
\end{DoxyParams}
\texorpdfstring{$<$}{<} Run voltage sensing and regulation.

\texorpdfstring{$<$}{<} Run current sensing and safety monitoring.
...
\hline
\end{DoxyParams}
\texorpdfstring{$<$}{<} Run gate driver control.
