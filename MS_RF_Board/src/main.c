...
void task_10ms_core_1(void *params) {
    ...
    while (1) {
        voltage_sensing_run();
        current_sensing_process(); // Cyclically update current sensing
        rtos_watchdog_feed(); // Feed the watchdog
...
void app_main() {
    ...
    rtos_create_task(task_100ms_core_0, "Task_100ms_Core_0", 2048, NULL, 1, &task_100ms_core_0_handle, 0);
    rtos_create_task(task_10000ms_core_0, "Task_10000ms_Core_0", 2048, NULL, 1, &task_10000ms_core_0_handle, 0);

    // Create tasks for Core 1
    rtos_create_task(task_1ms_core_1, "Task_1ms_Core_1", 2048, NULL, 2, &task_1ms_core_1_handle, 1);
    rtos_create_task(task_10ms_core_1, "Task_10ms_Core_1", 2048, NULL, 1, &task_10ms_core_1_handle, 1);
    rtos_create_task(task_1000ms_core_1, "Task_1000ms_Core_1", 2048, NULL, 1, &task_1000ms_core_1_handle, 1);

    ESP_LOGI("Main", "System initialized. Tasks running.");
}